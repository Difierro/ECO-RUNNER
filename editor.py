'''
    Escolhe mapa na variável 'mapa'
    
    scroll mouse para mudar o tile
    
    shift esquerdo + scroll para mudar a variante do mouse
    
    'o' para salvar
    
    't' para automaticamente organizar as variantes
...
class Editor:
    ...
    def run(self):
        while True:
            ...
            #self.display.blit(self.bg['background'], (0, 0))
